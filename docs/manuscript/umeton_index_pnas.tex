...
It was intentional to not take care into account co-first or co-last authorship. The U-index is designed to be among the most stringent and harder to game biobliometric metrics.
...
The U-index can be freely computed from public  bibliometric data. A prototype implementation is available \href{https://github.com/renato-umeton/u-index}{here}.
